...
const unsigned int MetaWatchTallTimeTable[TOTAL_TIME_CHARACTERS][50];
...
const unsigned char MetaWatchTallTimeWidth[TOTAL_TIME_CHARACTERS];
...
void SetFont(etFontType Type)
{
  ...
  case MetaWatchTallTime:
    CurrentFont.Type = Type;
    CurrentFont.Height = 50;
    CurrentFont.Spacing = 2;
    break;
...
{ 
  ...
  case MetaWatchTallTime:Width = MetaWatchTallTimeWidth[index]; break;
...
void GetCharacterBitmap(unsigned char Character,unsigned int * pBitmap)
{
  ...
  for (row = 0; row < CurrentFont.Height; row++ )
  {
    ...
    case MetaWatchTallTime:
      pBitmap[row] = MetaWatchTallTimeTable[index][row];
      break;
...
{
		/* character 0x30 ('0'): (width=16, offset=0) */
		0x3FFC, 0x7FFE,	0xFFFF,	0xFFFF,	0xF81F,	0xF00F,	0xF00F,	0xF00F,	0xF00F,	0xF00F,
		0xF00F, 0xF00F, 0xF00F,	0xF00F,	0xF00F,	0xF00F,	0xF00F,	0xF00F,	0xF00F,	0xF00F,
		0xF00F, 0xF00F,	0xF00F,	0xF00F,	0xF00F,	0xF00F, 0xF00F,	0xF00F,	0xF00F,	0xF00F,
		0xF00F, 0xF00F,	0xF00F,	0xF00F,	0xF00F,	0xF00F, 0xF00F,	0xF00F,	0xF00F,	0xF00F,
		0xF00F, 0xF00F,	0xF00F,	0xF00F, 0xF00F,	0xF81F,	0xFFFF, 0xFFFF,	0x7FFE,	0x3FFC,

		/* character 0x31 ('1'): (width=16, offset=32) */
		0x1F00, 0x3F80,	0x3F80,	0x3F80,	0x3F00,	0x3C00,	0x3C00,	0x3C00,	0x3C00,	0x3C00,
		0x3C00, 0x3C00,	0x3C00,	0x3C00, 0x3C00,	0x3C00,	0x3C00,	0x3C00,	0x3C00,	0x3C00,
		0x3C00, 0x3C00,	0x3C00,	0x3C00, 0x3C00,	0x3C00,	0x3C00,	0x3C00,	0x3C00,	0x3C00,
		0x3C00, 0x3C00,	0x3C00,	0x3C00, 0x3C00,	0x3C00,	0x3C00,	0x3C00,	0x3C00,	0x3C00,
		0x3C00, 0x3C00,	0x3C00,	0x3C00, 0x3C00,	0x3C00,	0x3C00,	0x3C00,	0x3C00,	0x1800,

		/* character 0x32 ('2'): (width=16, offset=64) */
		0x3FFC, 0x7FFE,	0xFFFF,	0xFFFF,	0xF81F,	0xF00F,	0xF00F,
		0xF00F,
		0xF006,
		0xF000,
		0xF000,
